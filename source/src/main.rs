                        ...
                        for p in &items {
                            ...
                            body.row(28.0, |mut row| {
                                row.col(|ui: &mut egui::Ui| {
                                    let click_id = egui::Id::new("row_click");
                                    let double_id = egui::Id::new("row_double");
                                    ...
                                    if resp.clicked() {
                                        ui.ctx().data_mut(|d| d.insert_temp(click_id, id));
                                    }
                                    if resp.double_clicked() {
                                        ui.ctx().data_mut(|d| d.insert_temp(double_id, id));
                                    }
                                    // 选中行背景
                                    if is_selected {
